...
if ~ isempty(bbox)  %if face exists
    ...
    if ~ isempty(bboxeyes)  %check it eyepair is available
        ...
        bboxeyeshalf=[bboxeyes(biggest_box_eyes,1)+20,bboxeyes(biggest_box_eyes,2),bboxeyes(biggest_box_eyes,3)/3,bboxeyes(biggest_box_eyes,4)];   %resize the eyepair width in half
